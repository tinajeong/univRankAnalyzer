...
2. import를 해줍니다.
   ...
   2. IntelliJ oneclick 기능에서 gradle import 버튼을 클릭합니다.
      ...
      ./home/migu/.config/Typora/typora-user-images

      ![image-20191101161649666](C:/Users/%EB%AF%B8%EA%B5%AC/git/univRankAnalyzer/doc/image-20191101161649666.png)
...
갑자기 뜬금없지만 외부 라이브러리를 어떻게 사용하는 것인지 스스로 공부하는 연습이 중요합니다.

이번에 사용하는 UniVocity Parsers는 비교적 쉽고 간단한 라이브러리입니다. 이와 같은 간단한 라이브러리들에서부터 시작하면 됩니다.
...
또한, 해당 collection들을 print할 때는 enhanced loop나 for each를 사용하는 것이 코딩시 편리합니다. primitive for loop를 사용했던 경험이 있는 분들은 자바의 해당 문법이 굉장히 편리하게 느껴질 것입니다.
...
이때까지 설명한 내용을 코드로 표현하면 다음과 같습니다.
